...
export default {
  ...
  settingsWindow: {
    ...
    theme: 'Theme',
    themeHint: 'Follow System matches the operating system appearance.',
  ...
  agent: {
    ...
    settings: {
      ...
      form: {
        ...
        fetchModelsOk: 'Added {n} model(s).',
        fetchModelsNone: 'Model list is already up to date.',
      ...
      audit: {
        ...
        clear: 'Save & Clean',
        clearDaysLabel: 'Auto-clean entries older than (days, 1–30)',
        clearConfirmTitle: 'Clear Audit',
        clearConfirm: 'Keep {days} days: delete older audit entries and save this setting (also cleaned automatically at app startup). This cannot be undone.',
  ...
  agentTrace: {
    ...
    clearConfirm: 'Delete the trace files of every session. This cannot be undone.',
    emptySessions: 'No traces yet. Run an agent conversation first.',
    pickSession: 'Pick a session on the left to see its timeline',
    emptyTrace: 'No records in this session',
    pickRecord: 'Pick a timeline record to inspect its full content',
    rendered: 'Rendered',
    rawJson: 'Raw JSON',
    copyJson: 'Copy JSON',
    copyRequest: 'Copy full request JSON',
    purposeChat: 'Chat completion',
    purposeCompact: 'Compaction summary',
