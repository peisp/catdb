...
export default {
  ...
  agent: {
    ...
    panel: {
      ...
      clearAll: '清空历史',
      clearTitle: '清空历史对话',
      clearConfirm: '删除所有会话及其消息记录？此操作不可撤销。',
      ...
      resizeHint: '拖动调整宽度',
      inputResizeHint: '拖动调整输入框高度，双击恢复自动',
    ...
    settings: {
      ...
      form: {
        ...
        fetchModelsOk: '新增 {n} 个模型。',
        fetchModelsNone: '模型列表已是最新。',
      ...
      audit: {
        ...
        clear: '保存并清理',
        clearDaysLabel: '自动清理早于（天，1–30）',
        clearConfirmTitle: '清理审计',
        clearConfirm: '保留 {days} 天：删除更早的审计记录并保存该设置（应用启动时也会自动清理）。此操作不可撤销。',
        cleared: '旧审计记录已清理',
  ...
  agentTrace: {
    ...
    clearAll: '清空',
    clearTitle: '清空追踪记录',
    clearConfirm: '删除所有会话的追踪文件。此操作不可撤销。',
    emptySessions: '暂无追踪记录。发起一次 Agent 对话后再来。',
    pickSession: '选择左侧的会话查看时间线',
    emptyTrace: '该会话暂无记录',
    pickRecord: '选择时间线中的一条记录查看完整内容',
    rendered: '渲染',
    rawJson: '原始 JSON',
    copyJson: '复制 JSON',
    copyRequest: '复制完整请求 JSON',
    purposeChat: '对话补全',
    purposeCompact: '压缩摘要',
    nMessages: '{n} 条消息',
    approved: '已批准',
